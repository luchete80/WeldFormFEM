...
//~ void run_simulation_martins(){
    ...
    //~ // ============ VTK: ESTADO INICIAL (PASO 0) ============
    //~ std::cout << "\n--- ESCRIBIENDO VTK PASO 0 ---" << std::endl;
    ...
    //~ for(int step = 0; step < nsteps; step++) {
        ...
        //~ // ============ VTK: CADA PASO DE TIEMPO ============
        //~ std::cout << "  ESCRIBIENDO VTK PASO " << step+1 << "..." << std::endl;
    ...
    //~ // ============ VTK: COLECCIÓN PVD PARA ANIMACIÓN ============
